...
Namespace Migrations
    ...
    Public NotInheritable Partial Class FechasDeReserva
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(FechasDeReserva))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201605262121539_FechasDeReserva"
            End Get
        End Property
