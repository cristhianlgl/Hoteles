...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ReservaUsuario
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ReservaUsuario))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201605261520569_ReservaUsuario"
            End Get
        End Property
